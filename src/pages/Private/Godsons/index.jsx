...
const Godsons = () => {
    ...
    useEffect(() => {
        const load = async () => {
           ...
           //     console.log('Response => Recrutas', response.data)
    ...
    return (
        <Fragment>
            <div className="d-flex justify-content-between align-items-center mb-2 mt-1">
                <h4 className="mb-0 text-dark fw-semibold">Recrutas</h4>
                <Button className="btn-primary py-2 px-3 d-flex align-items-center gap-2" onClick={() => toggleCreate()}><FaPlus /> <span>Novo Recruta</span></Button>
            </div>
                ...
                {isLoading ?
                    ...
                    <>
                        {data.length === 0 ?
                            <tbody>
                                <tr>
                                    <td colSpan={7} className="text-center text-dark py-3">Recrutas não encontrados</td>
                                </tr>
                            </tbody>
                            :
                            <>
                                        ...
                                        return (
                                            <tr key={index} className="border-start-0 border-end-0" style={{ border: "2px solid #D9D9D9", color: "var(--insignio-primary-text)" }}>
                                                ...
                                                <td className="d-flex justify-content-end gap-3 border-0">
                                                    <Link to={SYSTEM_ROUTES.GODSONS.show + item.id}>
                                                        <Button
                                                            type="button"
            ...
            {client && <ModalRemove godson={client} modal={modalRemove} toggle={toggleRemove} localRefetchData={localRefetchData} key={'ModalRemove'} />}
