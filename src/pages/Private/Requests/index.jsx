    ...
    return (
        <Fragment>
            <div className="d-flex justify-content-between align-items-center mb-2 mt-1">
                <h4 className="mb-0 text-dark fw-semibold">Requisições</h4>
                <Button className="btn-primary py-2 px-3 d-flex align-items-center gap-2" onClick={() => toggleCreate()}><FaPlus /> <span>Nova Requisição</span></Button>
            </div>
                                        ...
                                        return (
                                            <tr key={index} className="border-start-0 border-end-0" style={{ border: "2px solid #D9D9D9", color: "var(--insignio-primary-text)" }}>
                                                ...
                                                <td className="d-flex justify-content-end gap-3 border-0">
                                                    <Link to={SYSTEM_ROUTES.REQUESTS.show + item.id}>
                                                        <Button
                                                            type="button"
